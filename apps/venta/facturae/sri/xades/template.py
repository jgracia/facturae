...
def create_signature(c14n_method=False, sign_method=False, name=False, ns='ds'):
    node = etree.Element(etree.QName(DSigNs, 'Signature'), nsmap={ns: DSigNs, "etsi":"http://uri.etsi.org/01903/v1.3.2#"})
    node.text = '\n'
    if name:
