...
class NotaDebitoEstado(models.Model):
    notadebito_estado_id = models.AutoField(auto_created=True, primary_key=True, serialize=False)
...
class NotaDebito(models.Model):
    nota_debito_id = models.AutoField(auto_created=True, primary_key=True, serialize=False)
    ...
    update_at = models.DateTimeField(auto_now=True)
    #activo = models.BooleanField(default=True)
    estado = models.ForeignKey(NotaDebitoEstado, null=True, blank=True, on_delete=models.SET_NULL)
...
class NotaDebitoDetalle(models.Model):
    nota_debito_detalle_id = models.AutoField(auto_created=True, primary_key=True, serialize=False)
    nota_debito = models.ForeignKey(NotaDebito, null=False, blank=False, on_delete=models.CASCADE)
